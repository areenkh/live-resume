  ...
  async share() {
    try{
      await this.ngNavigatorShareService.share({
        title: "Live Resume - Areen Khalaila",
        text: "Hello, I'm a computer science student at Brandeis University. Find out more in my live-resume!",
        url: "https://areenkhalaila.com"
      });
    } catch(error) {
